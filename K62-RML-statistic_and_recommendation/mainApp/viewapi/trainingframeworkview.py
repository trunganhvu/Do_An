...
@login_required(login_url='/login/')
def trainingframework_new_form(request):
    trainingFramework = Major_Course.objects.all()
    ...
    if request.method == 'POST':
        courseNameInput = request.POST['courseName']
        majorNameInput = request.POST['majorName']
    return TemplateResponse(request, 'adminuet/trainingframeworkform.html', context=context)
